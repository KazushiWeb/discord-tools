...
client.on('ready', function() {
  ...
  client.user.setActivity(`🔮 ENBOT - ${client.user.username}`, { type: "Watching", url: 'https://www.twitch.tv/BotByenok' });
  ...
  console.log(
     ...
     `Invitation : https://discordapp.com/oauth2/authorize?client_id=${client.usser.id}&scope=bot&permissions=2146958847 \n` +
     `${"-".repeat(40)}\n`
 );
